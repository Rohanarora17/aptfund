import SM from "@/components/images/SocialMedia.jpeg" // Adjust the import path as needed
      ...
      <main className="flex-1 px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="order-2 md:order-1 space-y-6 ml-12">
            <h1 className="text-4xl font-bold">Social Media on Web 3</h1>
          ...
          <div className="order-1 md:order-2 relative group">
            ...
            <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
              <h3 className="text-xl font-semibold text-white">Social Media on Web 3</h3>
              <p className="text-white/80 text-sm">Revolutionizing the way we Social Media.</p>
            </div>
          </div>
        </div>
      </main>
