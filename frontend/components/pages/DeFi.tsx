  ...
  return (
    <div className="flex flex-col min-h-[100dvh] bg-gradient-to-br from-[rgb(108,0,162)] to-[rgb(0,17,82)]">
      ...
      <main className="flex-1 px-6 py-8">
        <h1 className="text-5xl font-bold pl-20">Defi</h1>
        <div className="flex justify-around items-center">
          <p className="text-white max-w-3xl">
            ...
            leveraging blockchain technology to create transparent systems
          </p>
          <img
            src={DefiImage}
            alt="Defi"
              ...
              <div className="flex flex-col items-start gap-4">
                <div className="flex items-center justify-evenly w-full">
                  ...
                  <div className="space-y-2">
                    <div className="text-black font-bold">Decentralised crypto exchange</div>
                    ...
                    <Button variant="ghost" className="mt-4 shadow-lg shadow-black/50 bg-black text-white" onClick={() => setLocation("/dashboard/Defi/exchange/")}>
                      View Project
                    </Button>
                  </div>
                </div>
              ...
              <div className="flex flex-col items-start gap-4">
                <div className="flex items-center justify-evenly w-full">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    ...
                    <Button variant="ghost" className="mt-4 shadow-lg shadow-black/50 bg-black text-white" onClick={() => setLocation("/dashboard/Defi/Arbitrage/")}>
                      View Project
                    </Button>
                  </div>
                </div>
