import imageai from "@/components/images/imageai.png" // Adjust the import path as needed
      ...
      <main className="flex-1 px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="order-2 md:order-1 space-y-6 ml-12">
            ...
            "Image generation uses artificial intelligence to create new, realistic images based on learned patterns  
            lfrom existing visuals. It leverages models like GANs to produce artwork, design, and creative content, 
            mimicking or enhancing human creativity. This technology is revolutionizing fields like digital art, 
          ...
          <div className="order-1 md:order-2 relative group">
            ...
            <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
              <h3 className="text-xl font-semibold text-white">Image Generator</h3>
              <p className="text-white/80 text-sm">One of the best AI for image generation.</p>
            </div>
          </div>
        </div>
      </main>
