import textai from "@/components/images/textai3.webp" // Adjust the import path as needed
      ...
      <main className="flex-1 px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="order-2 md:order-1 space-y-6 ml-12">
            <h1 className="text-4xl font-bold">Text Generator</h1>
            <p className="text-white">
            "Generative AI is a type of artificial intelligence that creates new content, such as text or images, by 
            learning patterns from large datasets. It leverages models like GPT to automate creativity and enhance
            personalized experiences. As it evolves, generative AI is transforming the landscape of art, design, and communication. "
            </p>
          ...
          <div className="order-1 md:order-2 relative group">
            ...
            <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
              <h3 className="text-xl font-semibold text-white">Text Generator</h3>
              <p className="text-white/80 text-sm">One of the best AI for text  generation.</p>
            </div>
          </div>
        </div>
      </main>
